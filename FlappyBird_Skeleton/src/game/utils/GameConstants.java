...
public final class GameConstants {
    ...
    public static final float FLAP_STRENGTH       = -7.0f;
    public static final int   PIPE_SPEED          = 4;
    public static final int   PIPE_SPAWN_INTERVAL = 1300;
    ...
    public static final int MONSTER_SPEED = 12;
    public static final int MONSTER_SPAWN_INTERVAL = 3000;

    public static final int BULLET_SPEED        = 12;
    public static final int BULLET_COOLDOWN = 500;
    public static final int BULLET_SPAWN_INTERVAL = 2500;
